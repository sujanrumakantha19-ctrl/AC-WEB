...
export default function PublicAuctionsPage() {
  ...
  const queryParams = useMemo(() => {
    return {
      status: filter === "ALL" ? undefined : filter === "PARKING" ? "LIVE" : filter,
      parkingSale: filter === "PARKING" ? true : undefined,
      excludeEnded: filter === "ALL" ? true : undefined,
      page,
      limit: PAGE_SIZE,
    };
  }, [filter, page]);
  ...
  const handleFilterChange = (f: "ALL" | "LIVE" | "PARKING" | "UPCOMING") => {
    setFilter(f);
    setPage(1);
  };
